...
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2003\\>', replacement = 'dois_mil_tres', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2004\\>', replacement = 'dois_mil_quatro', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2005\\>', replacement = 'dois_mil_cinco', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2006\\>', replacement = 'dois_mil_seis', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2007\\>', replacement = 'dois_mil_sete', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2008\\>', replacement = 'dois_mil_oito', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2009\\>', replacement = 'dois_mil_nove', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2010\\>', replacement = 'dois_mil_dez', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2011\\>', replacement = 'dois_mil_onze', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2012\\>', replacement = 'dois_mil_doze', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2013\\>', replacement = 'dois_mil_treze', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2014\\>', replacement = 'dois_mil_quatorze', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2015\\>', replacement = 'dois_mil_quinze', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2016\\>', replacement = 'dois_mil_dezesseis', x = x))
corpus1 <- lapply(corpus1, function(x) gsub(pattern = '\\<2017\\>', replacement = 'dois_mil_dezessete', x = x))
